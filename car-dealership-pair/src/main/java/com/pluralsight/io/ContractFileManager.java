...
public class ContractFileManager {
    ...
    public static void writeContract(Contract contract, Vehicle vehicle)
    {
             ...
             PrintWriter printWriter = new PrintWriter(fileOutputStream))
        {
            if (contract instanceof SalesContract) {
                ...
                printWriter.println("SALE|" + salesContract.getDateOfContract() + "|" + salesContract.getCustomerName()
                ...
                printWriter.println("LEASE|" + leaseContract.getDateOfContract() + "|" + leaseContract.getCustomerName()
